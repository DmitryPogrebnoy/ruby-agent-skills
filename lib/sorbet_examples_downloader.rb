...
# Downloads Sorbet examples from gems that use Sorbet type signatures
class SorbetExamplesDownloader
  GEMS = {
    "packwerk" => { repo: "Shopify/packwerk", branch: "main", lib_path: "lib" }
  }.freeze
  ...
  def extract_lib_path(full_name, prefix, lib_path)
    # Full expected prefix (e.g., "spoom-main/lib/")
